...
const Auth = () => {
  ...
  return (
    <div
      className="relative h-full w-full bg-[url('/images/images.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
        ...
        <div className="flex justify-center">
          <div
            ...
            <p className="text-neutral-500 mt-12">
              {variant === "login" ? "Бірінші рет?" : "Аккаунт бар ма?"}
            </p>
            <span
              onClick={toggleVariant}
              className="text-white ml-1 hover:underline cursor-pointer"
            >
              {variant === "login" ? "Аккаунт ашу" : "Логин"}
            </span>
          </div>
        </div>
      </div>
